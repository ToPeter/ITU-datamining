...
/***
 * The AprioriAlg.ItemSet class is used to store information concerning a single transaction.
...
public class ItemSet {
	...
	/***
	 * The PRIMES array is internally in the AprioriAlg.ItemSet-class' hashCode method
	 */
	private static final int[] PRIMES = { 2, 3, 5, 7, 11, 13, 17, 23, 27, 31, 37 };
     int[] set;

    /***
     * Creates a new instance of the AprioriAlg.ItemSet class.
    ...
    /**
     * Subtracts the given item from the ItemSet and returns the remaining ItemSet. Does this operation using the mathematical
     * abstraction of a set.
     * @param itemToSubtract an itemSet to be subtracted
     * @return the remaining ItemSet
     */
    ...
    /**
     * Evaluates if this subset is a subset of given itemset
     * @param theSet the set to be evaluated as a parent
     * @return
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < set.length; i ++){
            nameList.add(GamesPlayed.getGameName(set[i]).toString());
        }
    ...
    /**
     * Checks if the current itemSet lowerLevel subsets are contained in the itemSetList passed. Used for prunning
    ...
    /**
     * Generates all the lower subsets of the givem itemSet
